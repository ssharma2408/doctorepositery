...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.patientHistory.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.patient-histories.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('visit_date') ? 'is-invalid' : '' }}" type="text" name="visit_date" id="visit_date" value="{{ old('visit_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prescription') ? 'is-invalid' : '' }}" type="text" name="prescription" id="prescription" value="{{ old('prescription', '') }}" required>
