...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.announcements.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="clinic_id">{{ trans('cruds.announcement.fields.clinic') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.announcement.fields.clinic_helper') }}</span>
            </div>
            <div class="form-group">
